...
<body>
  ...
  <form action="registroproducto.php" method="POST">
    <div class="mb-3">
      <label for="form-label">ingresar el producto</label>
      <input type="text" class="form-control" name="nomProducto" />
    </div>

    <div class="mb-3">
      <label for="form-label">ingresar el precio</label>
  ...
  FROM producto INNER JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo ;";
      ...
      ?>
        <tr>
          ...
          <!--boton eliminar-->
          <td> <a target="_self" href="acciones/eliminarProductos.php?id=<?php echo $fila['codigo'] ?>"><i class="bi bi-trash text-danger"></i>Eliminar</td>
